...
combined_cop_train = np.stack([GRF_right_train.drop(columns="at risk of falls"),GRF_left_train.drop(columns="at risk of falls")],-1)
final_x_train = np.concatenate([combined_cop_train,gait_x_train],-1)
final_y_train = GRF_right_train["at risk of falls"]
combined_cop_test = np.stack([GRF_right_test.drop(columns="at risk of falls"),GRF_left_test.drop(columns="at risk of falls")],-1)
final_x_test = np.concatenate([combined_cop_test,gait_x_test],-1)
